...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdmp_pb_lua_trigger_module.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libdmp_pb_lua_trigger_module.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} `pkg-config --libs gthread-2.0` -shared -fPIC

${OBJECTDIR}/dmp_trigger_module.o: dmp_trigger_module.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I. -I. `pkg-config --cflags gthread-2.0` -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/dmp_trigger_module.o dmp_trigger_module.c

${OBJECTDIR}/lua_interface.o: lua_interface.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -I. -I. `pkg-config --cflags gthread-2.0` -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/lua_interface.o lua_interface.c
