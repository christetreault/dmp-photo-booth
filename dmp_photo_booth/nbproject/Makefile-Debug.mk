...
${OBJECTDIR}/console_queue.o: console_queue.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${OBJECTDIR}/console_queue.o console_queue.c

${OBJECTDIR}/error_handling.o: error_handling.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${OBJECTDIR}/error_handling.o error_handling.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/module.o: module.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${OBJECTDIR}/module.o module.c

${OBJECTDIR}/module_callbacks.o: module_callbacks.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${OBJECTDIR}/module_callbacks.o module_callbacks.c

${OBJECTDIR}/module_status_watchdog.o: module_status_watchdog.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${OBJECTDIR}/module_status_watchdog.o module_status_watchdog.c

${OBJECTDIR}/user_interface.o: user_interface.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${OBJECTDIR}/user_interface.o user_interface.c
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/console_queue_tests/console_queue_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.c}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} `pkg-config --libs gmodule-2.0` `pkg-config --libs gtk+-3.0` `pkg-config --libs glib-2.0`   

${TESTDIR}/TestFiles/f2: ${TESTDIR}/module_tests/module_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.c}   -o ${TESTDIR}/TestFiles/f2 $^ ${LDLIBSOPTIONS} `pkg-config --libs gmodule-2.0` `pkg-config --libs gtk+-3.0` `pkg-config --libs glib-2.0`   

${TESTDIR}/TestFiles/f3: ${TESTDIR}/tests/module_callbacks_tests.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
	${LINK.c}   -o ${TESTDIR}/TestFiles/f3 $^ ${LDLIBSOPTIONS} `pkg-config --libs glib-2.0` `pkg-config --libs gmodule-2.0` `pkg-config --libs gtk+-3.0`   
...
${TESTDIR}/console_queue_tests/console_queue_tests.o: console_queue_tests/console_queue_tests.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -I. `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${TESTDIR}/console_queue_tests/console_queue_tests.o console_queue_tests/console_queue_tests.c


${TESTDIR}/module_tests/module_tests.o: module_tests/module_tests.c 
	${MKDIR} -p ${TESTDIR}/module_tests
	${RM} $@.d
	$(COMPILE.c) -g -I. `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -MMD -MP -MF $@.d -o ${TESTDIR}/module_tests/module_tests.o module_tests/module_tests.c
...
${OBJECTDIR}/console_queue_nomain.o: ${OBJECTDIR}/console_queue.o console_queue.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/console_queue_nomain.o console_queue.c;\
	else  \
...
${OBJECTDIR}/error_handling_nomain.o: ${OBJECTDIR}/error_handling.o error_handling.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/error_handling_nomain.o error_handling.c;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/main_nomain.o main.c;\
	else  \
...
${OBJECTDIR}/module_nomain.o: ${OBJECTDIR}/module.o module.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/module_nomain.o module.c;\
	else  \
...
${OBJECTDIR}/module_callbacks_nomain.o: ${OBJECTDIR}/module_callbacks.o module_callbacks.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/module_callbacks_nomain.o module_callbacks.c;\
	else  \
...
${OBJECTDIR}/module_status_watchdog_nomain.o: ${OBJECTDIR}/module_status_watchdog.o module_status_watchdog.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/module_status_watchdog_nomain.o module_status_watchdog.c;\
	else  \
...
${OBJECTDIR}/user_interface_nomain.o: ${OBJECTDIR}/user_interface.o user_interface.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g `pkg-config --cflags gmodule-2.0 gthread-2.0 gtk+-3.0` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/user_interface_nomain.o user_interface.c;\
	else  \
