...
${OBJECTDIR}/camera_logic.o: camera_logic.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I. -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/camera_logic.o camera_logic.c

${OBJECTDIR}/camera_module.o: camera_module.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I. -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/camera_module.o camera_module.c
